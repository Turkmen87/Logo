...
| ----- | ---------- | ---------- | ---------- | ---------- | ------------ | --------------- | ---------- |
| 0 | 3 | LOGICALREF | Longint | 4 | 0 | DEFNFLDSCARDV Logical Reference | DEFNFLDSCARDV Logical Reference |
| 0 | 3 | MODULENR | Integer | 2 | 4 | Modül Numarası; ;4: Fatura;5: Cari Hesap;6: Malzeme | Module Number ;4: Invoice;5: AR/AP;6: Material |
| 0 | 3 | LEVEL_ | Byte | 1 | 6 | Seviye ; 0: Ana Kayıt; 1: Satır | Level ;0: Main Record;1: Line |
| 0 | 3 | PARENTREF | Longint | 4 | 7 | Modül Numarası Ref. | ModuleNr Reference |
| 0 | 3 | OWNERREF | Longint | 4 | 11 | Malzeme Hareketleri Ref. | Item Transactions Reference |
| 0 | 3 | TEXTFLDS1 | ZString | 51 | 15 | Kullanıcı tanımlı alan 1 (text) | User Defined Field1 (Text) |
| 0 | 3 | TEXTFLDS2 | ZString | 51 | 66 | Kullanıcı tanımlı alan 2 (text) | User Defined Field2 (Text) |
| 0 | 3 | TEXTFLDS3 | ZString | 51 | 117 | Kullanıcı tanımlı alan 3 (text) | User Defined Field3 (Text) |
| 0 | 3 | TEXTFLDS4 | ZString | 51 | 168 | Kullanıcı tanımlı alan 4 (text) | User Defined Field4 (Text) |
| 0 | 3 | TEXTFLDS5 | ZString | 51 | 219 | Kullanıcı tanımlı alan 5 (text) | User Defined Field5 (Text) |
| 0 | 3 | TEXTFLDS6 | ZString | 51 | 270 | Kullanıcı tanımlı alan 6 (text) | User Defined Field6 (Text) |
| 0 | 3 | TEXTFLDS7 | ZString | 51 | 321 | Kullanıcı tanımlı alan 7 (text) | User Defined Field7 (Text) |
| 0 | 3 | TEXTFLDS8 | ZString | 51 | 372 | Kullanıcı tanımlı alan 8 (text) | User Defined Field8 (Text) |
| 0 | 3 | TEXTFLDS9 | ZString | 51 | 423 | Kullanıcı tanımlı alan 9 (text) | User Defined Field9 (Text) |
| 0 | 3 | TEXTFLDS10 | ZString | 51 | 474 | Kullanıcı tanımlı alan 10 (text) | User Defined Field10 (Text) |
| 0 | 3 | TEXTFLDS11 | ZString | 51 | 525 | Kullanıcı tanımlı alan 11 (text) | User Defined Field11 (Text) |
| 0 | 3 | TEXTFLDS12 | ZString | 51 | 576 | Kullanıcı tanımlı alan 12 (text) | User Defined Field12 (Text) |
| 0 | 3 | TEXTFLDS13 | ZString | 51 | 627 | Kullanıcı tanımlı alan 13 (text) | User Defined Field13 (Text) |
| 0 | 3 | TEXTFLDS14 | ZString | 51 | 678 | Kullanıcı tanımlı alan 14 (text) | User Defined Field14 (Text) |
| 0 | 3 | TEXTFLDS15 | ZString | 51 | 729 | Kullanıcı tanımlı alan 15 (text) | User Defined Field15 (Text) |
| 0 | 3 | TEXTFLDS16 | ZString | 51 | 780 | Kullanıcı tanımlı alan 16 (text) | User Defined Field16 (Text) |
| 0 | 3 | TEXTFLDS17 | ZString | 51 | 831 | Kullanıcı tanımlı alan 17 (text) | User Defined Field17 (Text) |
| 0 | 3 | TEXTFLDS18 | ZString | 51 | 882 | Kullanıcı tanımlı alan 18 (text) | User Defined Field18 (Text) |
| 0 | 3 | TEXTFLDS19 | ZString | 51 | 933 | Kullanıcı tanımlı alan 19 (text) | User Defined Field19 (Text) |
| 0 | 3 | TEXTFLDS20 | ZString | 51 | 984 | Kullanıcı tanımlı alan 20 (text) | User Defined Field20 (Text) |
| 0 | 3 | TEXTFLDS21 | ZString | 51 | 1035 | Kullanıcı tanımlı alan 21 (text) | User Defined Field21 (Text) |
| 0 | 3 | TEXTFLDS22 | ZString | 51 | 1086 | Kullanıcı tanımlı alan 22 (text) | User Defined Field22 (Text) |
| 0 | 3 | TEXTFLDS23 | ZString | 51 | 1137 | Kullanıcı tanımlı alan 23 (text) | User Defined Field23 (Text) |
| 0 | 3 | TEXTFLDS24 | ZString | 51 | 1188 | Kullanıcı tanımlı alan 24 (text) | User Defined Field24 (Text) |
| 0 | 3 | TEXTFLDS25 | ZString | 51 | 1239 | Kullanıcı tanımlı alan 25 (text) | User Defined Field25 (Text) |
| 0 | 3 | TEXTFLDS26 | ZString | 51 | 1290 | Kullanıcı tanımlı alan 26 (text) | User Defined Field26 (Text) |
| 0 | 3 | TEXTFLDS27 | ZString | 51 | 1341 | Kullanıcı tanımlı alan 27 (text) | User Defined Field27 (Text) |
| 0 | 3 | TEXTFLDS28 | ZString | 51 | 1392 | Kullanıcı tanımlı alan 28 (text) | User Defined Field28 (Text) |
