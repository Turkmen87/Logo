...
| 1 | 3 | PAYMENTREF | Longint | 4 | 164 | Ödeme Planı Referansı | Payment Plan Reference |
...
| 1 | 3 | DOMINANTREFS1 | Longint | 4 | 183 | Genel Bilgiler (Üst Malzeme Sınıfı Referansı) | For General Information Parent Material Class Reference |
| 1 | 3 | DOMINANTREFS2 | Longint | 4 | 187 | Ambar Parametreleri (Üst Malzeme Sınıfı Referansı) | For Warehouse Parameters Parent Material Class Reference |
| 1 | 3 | DOMINANTREFS3 | Longint | 4 | 191 | Fabrika Parametreleri (Üst Malzeme Sınıfı Referansı) | For Plant Parameters Parent Material Class Reference |
| 1 | 3 | DOMINANTREFS4 | Longint | 4 | 195 | İş İstasyonu Parametreleri (Üst Malzeme Sınıfı Referansı) | For Workstation Parameters Parent Material Class Reference |
| 1 | 3 | DOMINANTREFS5 | Longint | 4 | 199 | Birimler (Üst Malzeme Sınıfı Referansı) | For Units Parent Material Class Reference |
| 1 | 3 | DOMINANTREFS6 | Longint | 4 | 203 | Fiyatlar (Üst Malzeme Sınıfı Referansı) | For Prices Parent Material Class Reference |
...
| 1 | 3 | ADDTAXREF | L_ADDTAX | LOGICALREF | one-to-one |  |
